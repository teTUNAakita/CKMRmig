...
So far, we provide the formulation of the estimators, presented in Equations 4-5 and 7-8, is a function with parent numbers for each population. 

; in this subsection, we provide the treatment for estimating the unknown parent numbers by additional usage of HS and/or PO pairs. 
