...
Estimating the number of migrants among the populations is essential for understanding population structure and dynamics. 
...
% 近年の移動率の推定には大きく２種類に分類される。１つ目は遺伝マーカーに基づく集団遺伝学的な解析。２つ目は標識採捕の枠組みの解析。
