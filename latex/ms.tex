...
\begin{align}
\widehat{M} &= \frac{N_{2} \widetilde{H}_{\rm HS, bet} } {4 n_{\rm O, 1} n_{\rm O, 2} }
\label{HS-3}
\end{align}

{\bf \noindent Realistic model: }
...
\begin{align}
\widehat{M} &= \frac{N_{2} \widetilde{H}_{\rm PO,bet} } {2 n_{\rm O, 1} n_{\rm P, 2} }
\label{PO-3}
\end{align}
