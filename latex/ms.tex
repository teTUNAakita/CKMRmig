...
Close-kin mark-recapture (CKMR) is a recently developed method for estimating adult population size along with life-history parameters that utilizes the information about kinship in a sample, owing to the recent advances in genetic methods for kinship determination \cite[]{https://doi.org/10.1111/faf.12615}. 
