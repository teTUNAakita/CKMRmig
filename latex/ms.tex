...
\title{Estimating migrantation rates using kinship pairs \protect\thanks{Running head line: Estimating migrantation rates using kinship pairs}}
...
\subsection{Hypothetical population and sampling scheme}

Suppose that we have a set of two populations labelled 1 and 2. 
