/*
g++ model_1.cpp -Wall -Wextra -o3 -std=c++17 -o model_2
./model_2 init_parent_pair_number_0 1 sampled_child_number_0 1
sampled_father_number_0 1  sampled_mother_number_0 1
migration_number lambda_0 lambda_1 flag_constant (total 12 parameters)
./model_2 10 10 3 3 2 2 2 2 3 3 5 0
*/
#include <iostream>
#include <fstream>
#include <vector>
...
public:
  ...
  void sampling_father(const size_t sampled_number, size_t rep) {
    std::vector<size_t> sampled_ids;
  ...
  void sampling_mother(const size_t sampled_number, size_t rep) {
    std::vector<size_t> sampled_ids;
...
int main(int argc, char *argv[])
{
  ...
  pop0.sampling_father(sampled_father_number_0, 0);
  pop0.sampling_mother(sampled_father_number_0, 0);
