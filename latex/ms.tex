...
% 1: Estimating migration is important for both ecologically and evolutionally reasons

In conservation and wildlife management, estimating the current ecological information is essential for monitoring population levels and for proposing management strategies. Contemporary migration rate, the recent rate of movement of individuals or gametes between populations, is a critical component to determine the current degree of synchrony among the population, which characterize the population structure and then provides information to identify appropriate management units \cite[]{Waples_2006_MolEcol, PALSBOLL200711}. In addition, \RED{KOKOMADE}


, estimating a speed of habitat expansion,  the effective reserve network design, population restoration, and invasive species control. 


of organism number of migrants between populations is essential for understanding population structure in conservation and wildlife management. , and its history, which provides . 

, which is a fundamental process for implementing conservation and wildlife management. Especially in fisheries management, migration rate is a critical component for delineating a synchrony among the population, providing appropriate management units. 
